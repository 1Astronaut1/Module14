...
let lamp=new typeOfDevice([true,'Теслаград'],'LightingBolt',1200,2018,'Максим')
let computer=new typeOfDevice([true,'DNS'],'Игровой компьютер',30000,2020,'Елена')
let stool=new typeOfDevice([false,'DarkWoood'],'Табуретка',300,2010,'Михаил')
lamp.check();
lamp.turnToogle();
lamp.check();
computer.check();
